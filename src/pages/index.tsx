...
const COLLAGE_PIECES: CollagePiece[] = [
  {
    src: '/assets/band.webp',
    jpg: '/assets/band.jpg',
    alt: 'Chico Romelo ao vivo',
    cap: 'ao vivo · 2026',
  },
  {
    src: '/assets/member-2.webp',
    jpg: '/assets/member-2.jpg',
    alt: 'Chico Romelo no palco',
    cap: 'energia no palco',
  },
  {
    src: '/assets/member-3.webp',
    jpg: '/assets/member-3.jpg',
    alt: 'Ensaio — Chico Romelo',
    cap: 'ensaio · lisboa',
  },
  {
    src: '/assets/member-4.webp',
    jpg: '/assets/member-4.jpg',
    alt: 'Marcus Quintela — vocalista',
    cap: 'voz e guitarra',
  },
  {
    src: '/assets/renan-live.webp',
    jpg: '/assets/renan-live.jpg',
    alt: 'Renan Castro — bateria',
    cap: 'na bateria',
  },
]
...
export default function HomePage({ novidades = [] }: HomePageProps) {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Chico Romelo é uma banda de pop rock e MPB em Lisboa. Ouça o EP de estreia e os singles no Spotify, Apple Music e YouTube."
        />
      ...
      <BandaSection id="banda">
        ...
        <BandaInner>
          <BandaCopy>
            ...
            <Kicker>
              Som <em>brasileiro</em>
              <br />
              <span className="outline">entre Lisboa</span>
              <br />e a rua.
            </Kicker>
            <Lead>
              A <b>Chico Romelo</b> nasce em Lisboa. Um som que cruza música brasileira, palco e
              cidade.
            </Lead>
            <BodyP>
              Energia ao vivo, proximidade com o público e vida de rua. Cinco vozes, uma batida só —
              feita para os bares pequenos, as praças cheias e tudo o que houver no meio.
            </BodyP>
          </BandaCopy>
          ...
          <Collage ref={collageRef}>
            ...
            <StampNovo className={collageRevealed ? 'revealed' : ''}>novo · 2026</StampNovo>
            <ColScribbleArrow className={collageRevealed ? 'revealed' : ''}>
              <svg width="110" height="54" viewBox="0 0 120 60" fill="none">
                <path
                  d="M5 30 C 25 5, 55 5, 75 25 S 110 50, 115 35"
                  stroke="#404015"
                  strokeWidth="3"
                  strokeLinecap="round"
                />
                <path
                  d="M105 28 L115 35 L107 42"
                  stroke="#404015"
                  strokeWidth="3"
                  strokeLinecap="round"
                  fill="none"
            ...
            <ColScribbleText className={collageRevealed ? 'revealed' : ''}>
              som da rua!
            </ColScribbleText>
          </Collage>
        </BandaInner>
        ...
        <MusicasHeader>
          <div>
            ...
            <Kicker $noMargin>
              Músicas
              <br />
              <span className="outline">para</span> <em>ouvir alto.</em>
            </Kicker>
          </div>
          <MusicasMeta>
            {`// EP DE ESTREIA`}
