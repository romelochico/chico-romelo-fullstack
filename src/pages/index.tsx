...
const COLLAGE_PIECES: CollagePiece[] = [
  { src: '/assets/band.webp',         jpg: '/assets/band.jpg',         alt: 'Chico Romelo ao vivo',        cap: 'ao vivo · 2026' },
...
const PIECE_STYLES: PieceStyle[] = [
  ...
  { top: 50,  left: 380, width: 235, height: 215, animation: 'polaroid-in-2 0.8s cubic-bezier(0.22,0.61,0.36,1) 0.25s forwards', zIndex: 3 },
