...
const Card = styled.div<{ $unread?: boolean }>`
  ...
  border: 1px solid
    ${({ $unread }) => ($unread ? 'rgba(200,169,110,0.25)' : 'rgba(255,255,255,0.07)')};
  border-radius: 10px;
  overflow: hidden;
                  ...
                  <CardActions onClick={e => e.stopPropagation()}>
                    ...
                    >
                      {m.read ? (
                        <>
                          <MailOpen />
                          <span className="btn-label"> Marcar como não lida</span>
                        </>
                      ) : (
                        <>
                          <MailCheck />
                          <span className="btn-label"> Marcar como lida</span>
                        </>
                      )}
                    </ToggleReadBtn>
