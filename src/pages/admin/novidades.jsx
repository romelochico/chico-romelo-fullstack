...
export default function AdminNovidadesPage() {
  ...
  async function handleSave() {
    ...
    const payload = {
      ...
      date_label: form.date_label.trim() || defaultDateLabel(),
      body: form.body.trim(),
      image_id: form.image_id || null,
      link_url: form.link_url.trim() || null,
      link_label: form.link_url.trim() ? (form.link_label.trim() || 'Ler mais →') : null,
          ...
          <ModalBox>
            ...
            <ModalBody>
              ...
              <Field>
                <Label>
                  Texto *
                  <CharCount $over={form.body.length > MAX_CHARS}>
