...
export const ContactInner = styled.div`
  ...
  @media (max-width: ${({ theme }) => theme.breakpoints.tablet}) { flex-direction: column; gap: 50px; }
`
...
export const FormWrap = styled.div`
  ...
  p.intro {
    ...
    margin: 20px 0 32px; max-width: 520px;
  }
`

export const Kicker = styled.h2`
  font-family: ${({ theme }) => theme.fonts.display};
  font-size: clamp(52px, 7vw, 120px); line-height: 0.88;
  letter-spacing: 0.02em; text-transform: uppercase;
  margin: 20px 0 0; color: ${({ theme }) => theme.colors.charcoal};

  em { font-style: normal; color: ${({ theme }) => theme.colors.olive}; }
`

export const ContactForm = styled.form`
  display: flex; flex-direction: column; gap: 20px; max-width: 560px;
`

export const FormRow = styled.div`
  display: flex; gap: 16px;

  @media (max-width: ${({ theme }) => theme.breakpoints.small}) { flex-direction: column; gap: 20px; }
`
...
export const SubmitBtn = styled.button`
  ...
  border: 2px solid ${({ theme }) => theme.colors.charcoal};
  border-radius: 999px;
  font-family: ${({ theme }) => theme.fonts.body}; font-weight: 600; font-size: 15px;
...
export const FormSuccess = styled.div`
  ...
  h3 { font-family: ${({ theme }) => theme.fonts.display}; font-size: 28px; text-transform: uppercase; margin: 0 0 8px; }
  p  { font-size: 14px; opacity: 0.8; margin: 0; }
`

// ── SIDEBAR ───────────────────────────────────────────────────
export const Sidebar = styled.div`
  flex: 0.65; min-width: 0;
...
export const DirectCard = styled.div`
  ...
  &::before { content: '✦'; position: absolute; top: -14px; left: 16px; font-size: 28px; color: ${({ theme }) => theme.colors.tape}; }

  h4 { font-family: ${({ theme }) => theme.fonts.display}; font-size: 24px; text-transform: uppercase; margin: 0 0 18px; }
`
...
export const DirectRow = styled.div`
  ...
  svg { width: 18px; height: 18px; flex-shrink: 0; margin-top: 2px; opacity: 0.7; }
`
...
export const DirectValue = styled.span`
  ...
  a {
    ...
    &:hover { text-decoration-color: ${({ theme }) => theme.colors.cream}; }
  }
`
...
export const SocialCard = styled.div`
  ...
  h4 { font-family: ${({ theme }) => theme.fonts.display}; font-size: 22px; text-transform: uppercase; margin: 0 0 18px; }
`
...
export const SocialLink = styled.a`
  ...
  &:hover { border-color: ${({ theme }) => theme.colors.olive}; transform: translateX(4px); }

  svg { width: 22px; height: 22px; flex-shrink: 0; color: ${({ theme }) => theme.colors.charcoal}; }

  .name  { font-family: ${({ theme }) => theme.fonts.display}; font-size: 18px; text-transform: uppercase; flex: 1; }
  .arrow { font-size: 16px; opacity: 0.4; transition: opacity 0.2s; }
...
export const LocationStamp = styled.div`
  ...
  svg { width: 32px; height: 32px; color: ${({ theme }) => theme.colors.olive}; flex-shrink: 0; }

  span {
    font-family: ${({ theme }) => theme.fonts.hand};
    font-size: 22px; color: ${({ theme }) => theme.colors.olive}; line-height: 1.2;
  }
`
